  ...
  return (
    <div>
        ...
        >
          {/* <div className='bg-gradient-to-r from-black'> */}
            <div className='pt-16' >
              ...
              <h1 className='text-3xl font-bold pl-12'></h1>
            </div>
          {/* </div> */}
        </div>
        ...
        <div className='p-12 grid grid-cols-2 gap-8'>
          ...
          <div className='p-7'>
            <h3 className='text-2xl py-2 max-w-lg'>We have sent you an email with the PDF version so that you can access it anytime!</h3>
          ...
          > 
            <div className='flex flex-col bg-gradient-to-r from-black'>
              <div className='pl-8 h-96'>
                ...
                <p className='py-8 text-grey max-w-md'>Refer us leads and start earning massive commissions already! Or find honest solutions to all your queries</p>
                <button className='bg-primary p-3 py-2 w-40 h-12 text-white rounded'>CONTACT US</button>
              </div> 
            </div>
          </div>

          <div className='bg-footerbg text-white h-72'>
            <div className='p-16 grid grid-cols-2'>
              <div className=''>
                <div>DogmaGroup</div>
                <p className='py-4 text-grey'>A group of companies helping you understand the fuller picture of cutting edge technology and implement it effectively.</p>
